...
import './discussionpage.css'; // Import your CSS file
            ...
            <div>
                {discussions.map((discussion) => (
                    <div key={discussion._id} className="discussion">
                        ...
                        <button className="reply-button" onClick={() => setSelectedDiscussionId(discussion._id)}>Reply</button>
                            ...
                            {selectedDiscussionId === discussion._id && (
                                <div>
                                    <textarea
                                        ...
                                        maxLength={80}
                                    />
                                    <button onClick={() => handleReply(discussion._id)}>Submit Reply</button>
                                </div>
                            )}
                        </div>
                    </div>
