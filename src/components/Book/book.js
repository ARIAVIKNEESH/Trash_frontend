...
class Book extends React.Component {
    ...
    fetchRecommendedBooks = () => {
        ...
        const requests = userGenres.map(genre => {
            const genreQuery = `subject:${genre}&maxResults=5`;
                    ...
                    <div className="viewed-books-section">
                        ...
                        <div className="book-list-viewed">
                            {viewedBooks.length > 0 ? (
                                ...
                                <p>No previously viewed books found.</p>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="user-genres-section">
                        ...
                        <ul className="genre-list">
                            {userGenres.length > 0 ? (
                                ...
                                <li>No preferred genres found.</li>
                            )}
                        </ul>
                    </div>
